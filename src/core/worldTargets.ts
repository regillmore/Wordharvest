    ...
    return [
      {
        ...
        position: { x: houseBedPosition.x - 0.42, y: houseBedPosition.y + 0.08 },
        distance: 0,
  ...
  return [
    {
      ...
      position: { x: houseInteriorExitPosition.x + 0.68, y: houseInteriorExitPosition.y - 0.08 },
    ...
    },
    {
      ...
      position: { x: houseBedPosition.x, y: houseBedPosition.y + 0.16 },
