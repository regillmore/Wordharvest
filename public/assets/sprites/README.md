...
- `player_base_v001.png`: twelve `32x40` player cells with transparent padding.
...
- The runtime uses idle plus two-frame walking loops for down, up, left, and right movement.
